...
namespace JudahsSpeedUtils
{
    public class Tools : MonoBehaviour
    {
        ...
        public float FlightHeight = 0.24f;
        ...
        public void Update()
        {
            ...
            if (coreHasBeenSetup)
            {
                ...
                if (FreezeHeight)
                {
                    ...
                    float movex = player.moveAxisX * FlightSpeed;
                    float movez = player.moveAxisY * FlightSpeed;

                    player.SetVelocity(new Vector3(movex, FlightHeight, movez));
                    
                    //player.SetVelocity(new Vector3(movex, 0f, movez));
        ...
        public void IncreaseFlyHeight()
        {
            FlightHeight += .01f;
        }

        public void DecreaseFlyHeight()
        {
            FlightHeight -= .01f;
        }
